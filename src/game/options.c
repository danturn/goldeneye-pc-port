...
#if defined(PORT)
#include "port_addr.h"
/* D298/M2: s32 locals hold N64 addresses (langGet/font bank); re-base where
 * they become pointers. Identity at PORT_ADDR_BASE == 0. */
...
Gfx *draw_abort_cancel_confirm(Gfx *gdl)
{
    ...
    if (watch_item_is_actively_selected != 0)
    {
        textMeasure(&sp60, &sp64, OPT_N64PTR(char, sp54), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);

        gdl = textRender(gdl, &sp7C, &sp70, OPT_N64PTR(char, sp54), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xA0FFA0F0, sp64, sp60, 0, 0);

        if (D_800409A4 != 0)
        {
            gdl = textRenderOutlined(gdl, &sp78, &sp6C, OPT_N64PTR(char, sp50), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), -1, 0x7000A0, viGetX(), viGetY(), 0, 0);
            gdl = textRender(gdl, &sp74, &sp68, OPT_N64PTR(char, sp4C), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xFF00B0, viGetX(), viGetY(), 0, 0);
        }
        else
        {
            if (D_800409A4 == 0)
            {
                gdl = textRender(gdl, &sp78, &sp6C, OPT_N64PTR(char, sp50), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xFF00B0, viGetX(), viGetY(), 0, 0);
                gdl = textRenderOutlined(gdl, &sp74, &sp68, OPT_N64PTR(char, sp4C), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), -1, 0x7000A0, viGetX(), viGetY(), 0, 0);
            }
        }
    }
    else
    {
        textMeasure(&sp60, &sp64, OPT_N64PTR(char, sp54), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);
        gdl = textRender(gdl, &sp7C, &sp70, OPT_N64PTR(char, sp54), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0x800080, sp64, sp60, 0, 0);
        gdl = textRender(gdl, &sp78, &sp6C, OPT_N64PTR(char, sp50), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0x800080, viGetX(), viGetY(), 0, 0);
        gdl = textRender(gdl, &sp74, &sp68, OPT_N64PTR(char, sp4C), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0x800080, viGetX(), viGetY(), 0, 0);
    }
...
Gfx *draw_text_mission_status(Gfx *gdl)
{
    ...
    textMeasure(&sp5C, &sp58, OPT_N64PTR(char, txtptr_1), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);
    sp64 = 0x51;
    sp60 = YOFFSET_MISSIONSTATUS;
    gdl = textRender(gdl, &sp64, &sp60, OPT_N64PTR(char, txtptr_1), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xFF00B0, sp58, sp5C, 0, 0);
    ...
    sp60 = sp60 - sp5C;
    textMeasure(&sp5C, &sp58, OPT_N64PTR(char, txtptr_2), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);
    gdl = textRender(gdl, &sp64, &sp60, OPT_N64PTR(char, txtptr_2), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), sp4C, sp58, sp5C, 0, 0);
...
Gfx *draw_text_q_watch_v201_beta(Gfx *gdl)
{
    ...
    pFontChars = ptrFontBankGothicChars;
    gdl = microcode_constructor(gdl);
    textMeasure(&sp48, &sp44, OPT_N64PTR(char, txtptr), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);
    gdl = textRender(gdl, &sp50, &sp4C, OPT_N64PTR(char, txtptr), OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xFF00B0, sp44, sp48, 0, 0);
    return gdl;
}
...
Gfx* draw_current_hand_item_and_ammo(Gfx* gdl) {
    ...
    sp88 = 0xBC;
#endif
    textMeasure(&sp84, &sp80, text, OPT_N64PTR(struct fontchar, sp78), OPT_N64PTR(struct font, sp7C), 0);
    gdl = textRender(gdl, &sp8C, &sp88, text, OPT_N64PTR(struct fontchar, sp78), OPT_N64PTR(struct font, sp7C), 0xFF00B0, sp80, sp84, 0, 0);
    ...
    sp88 = 0xC6;
#endif
    textMeasure(&sp84, &sp80, text2, OPT_N64PTR(struct fontchar, sp78), OPT_N64PTR(struct font, sp7C), 0);
    gdl = textRender(gdl, &sp8C, &sp88, text2, OPT_N64PTR(struct fontchar, sp78), OPT_N64PTR(struct font, sp7C), 0xFF00B0, sp80, sp84, 0, 0);
...
#define WATCH_INV_BASE_Y() 0x8C
            ...
            textMeasure(&textheight, &textwidth, string_builder_allocation, OPT_N64PTR(struct fontchar, pFontChars2), OPT_N64PTR(struct font, pFontFile2), LINEHEIGHT());

            gdl = microcode_constructor_related_to_menus(gdl, 0x4E, WATCH_INV_BASE_Y(), textwidth + 0x4E, (LINEHEIGHT() * 5) + WATCH_INV_BASE_Y(), 0);

            gdl = textRender(gdl, &x1, &y1, string_builder_allocation, OPT_N64PTR(struct fontchar, pFontChars2), OPT_N64PTR(struct font, pFontFile2), 0xAA00B0, textwidth + 1, LINEHEIGHT() * 5, watch_inventory_text_y, LINEHEIGHT());
...

            {
                ...
                textMeasure(&y2, &x2, formattedString, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);

                if (watch_inventory_text_is_settled != 0)
                {
                    textMeasure(&y2, &x2, invItemName, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), LINEHEIGHT());
                    ...
                    if (D_800409C4 == 0)
                    {
                        gdl = textRender(gdl, &x1, &y1, invItemName, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xA0FFA0F0, x2, 0x64, 0, LINEHEIGHT());
                    }
                    else
                    {
                        gdl = textRenderOutlined(gdl, &x1, &y1, invItemName, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), -1, 0x7000A0, x2 + 1, 0x64, 0, LINEHEIGHT());
                    }
...
Gfx *unused_draw_watch_inventory_page(Gfx *gdl, Mtx *param_2) {
    ...
    if (check_watch_page_transistion_running() != 1)
    {
        ...
        textMeasure(&sp58, &sp54, long_name, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);
        ...
        if (watch_inventory_text_is_settled)
        {
            ...
            if (D_800409C4 == 0)
            {
                gdl = textRender(gdl, &sp70, &sp6C, long_name, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xA0FFA0F0, sp54, 0x64, 0, 0);
            }
            else
            {
                gdl = textRenderOutlined(gdl, &sp70, &sp6C, long_name, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), -1, 0x7000A0, sp54 + 1, 0x64, 0, 0);
            }
        }
        else
        {
            gdl = textRender(gdl, &sp70, &sp6C, long_name, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0xAA00B0, sp54, 0x64, 0, 0);
        }
...
Gfx *display_text_buttons_dual_control(Gfx *gdl)
{
    ...
    if (joyGetButtons(PLAYER_1, Z_TRIG))
    {
        gdl = draw_options_labels(gdl, 0x5A, YOFFSET_5, OPT_N64PTR(char, textptr_aux), -1, 1, 0x7000A0, 0, 0, 0x3000B0, 0);
    }
    else
    {
        gdl = draw_options_labels(gdl, 0x5A, YOFFSET_5, OPT_N64PTR(char, textptr_aux), 0xAA00B0, 0, -1, 0, 0, 0x3000B0, 0);
    }
    ...
    gdl = draw_options_labels(gdl, 0x5A, YOFFSET_4, OPT_N64PTR(char, textptr_aux), 0xAA00B0, 0, -1, 0, 0, 0x3000B0, 0);
    ...
    {
        gdl = draw_options_labels(gdl, 0xE6, YOFFSET_5, OPT_N64PTR(char, textptr_aux), -1, 1, 0x7000A0, 0, 0, 0x3000B0, 1);
    }
    else
    {
        gdl = draw_options_labels(gdl, 0xE6, YOFFSET_5, OPT_N64PTR(char, textptr_aux), 0xAA00B0, 0, -1, 0, 0, 0x3000B0, 1);
    }
    ...
    gdl = draw_options_labels(gdl, 0xE6, YOFFSET_4, OPT_N64PTR(char, textptr_aux), 0xAA00B0, 0, -1, 0, 0, 0x3000B0, 1);
    return gdl;
}
...
Gfx *draw_watch_control_options_page(Gfx *gdl, Mtx *param_2) {
    ...
    if (check_watch_page_transistion_running() != 1) {
        ...
        textMeasure(&sp50, &sp54, textptr, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);

        if ((watch_item_is_actively_selected != 0) && (controller_options_index == CONTROLLER_OPTIONS_INDEX_STYLE))
        {
            gdl = textRenderOutlined(gdl, &sp5C, &sp58, textptr, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), phi_s1, 0x7000A0, sp54 + 1, sp50, 0, 0);
        } else
        {
            gdl = textRender(gdl, &sp5C, &sp58, textptr, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), phi_s1, sp54, sp50, 0, 0);
        }
...
Gfx *draw_watch_game_options_page(Gfx *gdl, Mtx *param_2) {
    ...
    if (check_watch_page_transistion_running() != 1)
    {
        ...
        textMeasure(&sp48, &sp4C, textptr, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), 0);

        if ((watch_item_is_actively_selected != 0) && (game_options_index == 0))
        {
            gdl = textRenderOutlined(gdl, &sp54, &sp50, textptr, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), sp5C, 0x7000A0, sp4C + 1, sp48, 0, 0);
        }
        else
        {
            gdl = textRender(gdl, &sp54, &sp50, textptr, OPT_N64PTR(struct fontchar, pFontChars), OPT_N64PTR(struct font, pFontFile), sp5C, sp4C, sp48, 0, 0);
        }
